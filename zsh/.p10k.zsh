# Generated by Powerlevel10k configuration wizard on 2021-04-21 at 19:46 CEST.
...
() {
  ...
  function my_git_formatter() {
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      (( $#branch > 128 )) && branch[13,-13]="…"  # <-- this line
  ...
  typeset -g POWERLEVEL9K_VPN_IP_INTERFACE='(gpd|ppp|wg|(.*tun)|tailscale)[0-9]*'
